...
static int cmd_motor_profile_move(const struct shell *sh, size_t argc, char **argv)
{
	if (argc != 4) {
...
static int cmd_motor_profile_cancel(const struct shell *sh, size_t argc, char **argv)
{
	ARG_UNUSED(argc);
	ARG_UNUSED(argv);
...
static int cmd_motor_chopper_calib_clear(const struct shell *sh, size_t argc, char **argv)
{
	ARG_UNUSED(argc);
	ARG_UNUSED(argv);
...
static int cmd_motor_chopper_calib_start(const struct shell *sh, size_t argc, char **argv)
{
	if (argc != 4) {
...
static int cmd_motor_chopper_calib_stop(const struct shell *sh, size_t argc, char **argv)
{
	ARG_UNUSED(argc);
	ARG_UNUSED(argv);
...
static int cmd_motor_chopper_calib_status(const struct shell *sh, size_t argc, char **argv)
{
	ARG_UNUSED(argc);
	ARG_UNUSED(argv);
...
static int cmd_motor_chopper_calib_apply(const struct shell *sh, size_t argc, char **argv)
{
	ARG_UNUSED(argc);
	ARG_UNUSED(argv);
