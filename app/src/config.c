...
void config_init_runtime_adapters(struct motor_parameters *params)
{
	...
	params->rt_adapters.outer_loop = (struct motor_outer_loop_runtime_ctx){
		...
		.electrical_ripple_ff_cfg = &params->electrical_ripple_ff_cfg,
		.electrical_ripple_ff_state = &params->electrical_ripple_ff_state,
		.live_electrical_ripple_iq_ff_a = &params->live.electrical_ripple_iq_ff_a,
