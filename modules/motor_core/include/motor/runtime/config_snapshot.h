...
enum motor_rt_mode_flag {
	...
	MOTOR_RT_MODE_ONLINE_VELOCITY_GENERATED = BIT(8),
	MOTOR_RT_MODE_ONLINE_CURRENT_ENCODER = BIT(9),
	MOTOR_RT_MODE_ONLINE_VELOCITY_ENCODER = BIT(10),
	MOTOR_RT_MODE_ONLINE_POSITION_ENCODER = BIT(11),
	MOTOR_RT_MODE_ONLINE_POSITION_GENERATED = BIT(12),
