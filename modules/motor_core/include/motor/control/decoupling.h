...
#ifndef MOTOR_DECOUPLING_H_
#define MOTOR_DECOUPLING_H_

#include <stdbool.h>

#include <zephyr/dsp/types.h>

struct motor_decoupling_enable_input {
...
struct motor_decoupling_feedforward_input {
	bool enabled;
...
struct motor_decoupling_feedforward_output {
	float32_t vd_ff_v;
	float32_t vq_ff_v;
};
