...
#define MOTOR_MPR_VELOCITY_BW_R_MIN 1.0f
...
#define MOTOR_MPR_VELOCITY_BW_Q_REF_HZ 0.5f
#define MOTOR_MPR_VELOCITY_BW_MODEL_SCALE 16.0f
#define MOTOR_MPR_VELOCITY_BW_DI_BASE_FRAC 0.002f
#define MOTOR_MPR_VELOCITY_BW_DI_BW_FRAC 0.008f
#define MOTOR_MPR_VELOCITY_BW_DI_REF_HZ 10.0f
#define MOTOR_MPR_VELOCITY_BW_DIST_KI_FRAC 0.0065f
#define MOTOR_MPR_VELOCITY_BW_DIST_KI_MAX 0.0010f
